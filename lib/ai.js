...
// Configurable para poder bajar a un modelo más barato sin tocar código.
const MODEL = process.env.FINBOT_MODEL ?? 'claude-opus-5'
...
const KEYWORDS = {
  alimentacion: ['cafe', 'café', 'tinto', 'almuerzo', 'comida', 'mercado', 'restaurante', 'desayuno', 'cena', 'pizza',
    'super', 'domicilio', 'rappi', 'panaderia', 'panadería', 'helado', 'sushi', 'empanada'],
  transporte: ['taxi', 'uber', 'bus', 'gasolina', 'metro', 'parqueadero', 'parqueo', 'peaje', 'didi', 'pasaje',
    'moto', 'carro', 'tren', 'vuelo', 'avion', 'avión'],
  vivienda: ['arriendo', 'alquiler', 'renta', 'administracion', 'administración', 'hipoteca', 'mudanza'],
  servicios: ['luz', 'agua', 'internet', 'celular', 'gas', 'netflix', 'spotify', 'plan', 'recibo', 'factura', 'datos'],
  salud: ['farmacia', 'medico', 'médico', 'droga', 'eps', 'gimnasio', 'gym', 'odontologo', 'odontólogo', 'vitaminas',
    'consulta', 'examenes', 'exámenes'],
  entretenimiento: ['cine', 'bar', 'cerveza', 'fiesta', 'concierto', 'juego', 'salida', 'teatro', 'billar'],
  educacion: ['curso', 'libro', 'universidad', 'colegio', 'matricula', 'matrícula', 'taller', 'diplomado'],
  compras: ['ropa', 'zapatos', 'tecnologia', 'tecnología', 'amazon', 'regalo', 'mercadolibre', 'peluqueria',
    'peluquería', 'muebles', 'maquillaje'],
}
